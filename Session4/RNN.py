...
# Build the computation graph RNN
class RNN:
    ...
    def LSTM_layer(self, embeddings):
        ...
        lstm_outputs = tf.concat(lstm_outputs, axis=0)  # [num_docs * MAX_SENT_LENGTH, lstm_size]
        ...
        lstm_outputs_average = lstm_outputs_sum / tf.expand_dims(
            ...
            # expand_dims only works with tensor or float type
...
# Train and evaluate the model in the test data
